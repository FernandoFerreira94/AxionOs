    ...
    <Card className="border-gray-400/20 bg-white/5 mb-3 overflow-hidden py-1 active:scale-[0.98] transition-transform">
      <CardContent className="p-4">
        ...
        <div className="flex justify-between items-start mb-4">
          <div className="flex flex-col gap-1">
            <div className="flex items-center gap-2">
               <span className="text-blue-400 font-mono font-bold text-sm">{data.os}</span>
        ...
        <div className="grid grid-cols-2 gap-y-4 gap-x-2">
          {/* Status e Tipo */}
          <div className="flex flex-col gap-1">
            <span className="text-[9px] text-slate-500 uppercase font-bold">Status / Serviço</span>
          ...
          {/* Categoria */}
          <div className="flex flex-col gap-1">
            <span className="text-[9px] text-slate-500 uppercase font-bold">Setor</span>
            <BadgeFuncao funcao={data.tipo as string} />
          </div>

          {/* Técnico */}
          <div className="flex flex-col gap-1 col-span-1">
            <span className="text-[9px] text-slate-500 uppercase font-bold">Responsável</span>
          ...
          {/* Data */}
          <div className="flex flex-col gap-1 col-span-1">
            <span className="text-[9px] text-slate-500 uppercase font-bold">Data Referência</span>
